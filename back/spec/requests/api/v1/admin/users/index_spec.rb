...
RSpec.describe 'Api::V1::Admin::Users', type: :request do
  # GET /api/v1/admin/users(.json) ユーザー一覧API
  # 前提条件
  #   なし
  # テストパターン
  ...
  describe 'GET #index' do
    subject { get api_v1_admin_users_path(page: subject_page, format: :json), headers: auth_headers }
    ...
    shared_examples_for '[管理者APIログイン中]ユーザーが最大表示数と同じ' do
      include_context 'ユーザー一覧作成', Settings['default_users_limit']
    ...
    shared_examples_for '[管理者APIログイン中]ユーザーが最大表示数より多い' do
      include_context 'ユーザー一覧作成', Settings['default_users_limit'] + 1
      it_behaves_like 'ToOK', 1
    ...
    context '管理者APIログイン中' do
      ...
      it_behaves_like '[管理者APIログイン中]ユーザーが最大表示数と同じ'
      it_behaves_like '[管理者APIログイン中]ユーザーが最大表示数より多い'
    end
  end
end

...
RSpec.describe 'Api::V1::Admin::Users', type: :request do
  # POST /api/v1/admin/users/:username/delete(.json) ジャンル削除API(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, APIログイン中, 管理者APIログイン中
  describe 'POST #destroy' do
    subject { post api_v1_admin_destroy_user_path(username: other_user.username, format: :json), headers: auth_headers }
    ...
    context '管理者APIログイン中' do
      ...
      it_behaves_like 'OK'
      it_behaves_like 'ToMsg', 200, true, nil, 'notice.user.destroy'
    end
  end
end

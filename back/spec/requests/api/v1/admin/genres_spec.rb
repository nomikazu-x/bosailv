...
RSpec.describe Api::V1::Admin::GenresController, type: :request do
  describe 'POST /api/v1/admin/genres' do
    subject(:call_api) { post '/api/v1/admin/genres/create.json', headers: headers, params: params }
  ...
  describe 'POST /api/v1/admin/genres/:id/update' do
    subject(:call_api) { post "/api/v1/admin/genres/#{genre.id}/update.json", headers: headers, params: params }
  ...
  describe 'POST /api/v1/admin/genres/:id/delete' do
    subject(:call_api) { post "/api/v1/admin/genres/#{genre.id}/delete.json", headers: headers }

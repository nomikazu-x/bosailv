...
RSpec.describe 'Api::V1::Auth::Registrations', type: :request do
  ...
  describe 'POST #destroy' do
    subject { post destroy_auth_registration_path(format: :json), headers: auth_headers }
    ...
    context 'APIログイン中' do
      ...
      it_behaves_like 'ToMsg', NilClass, 0, nil, nil, nil, 'devise.registrations.destroyed'
    end
  end
end

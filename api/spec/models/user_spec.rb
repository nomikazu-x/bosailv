...
#       it "エラーになる" do
#         user.valid?
#         expect(user.errors.messages[:email]).to include "入力してください。"
#       end
#     end
...
#       it "エラーになる" do
#         user.valid?
#         expect(user.errors.messages[:password]).to include "入力してください。"
#       end
#     end
#   end
...
#       it "エラーになる" do
#         user2.valid?
#         expect(user2.errors.messages[:email]).to include "既に使用されています。"
#       end
#     end
...
#       it "エラーになる" do
#         user2.valid?
#         expect(user2.errors.messages[:username]).to include "既に使用されています。"
#       end
#     end
#   end
...
#       it "エラーになる" do
#         user.valid?
#         expect(user.errors.messages[:password]).to include "8文字以上で入力してください。"
#       end
#     end
...
#       it "エラーになる" do
#         user.valid?
#         expect(user.errors.messages[:name]).to include "50文字以下で入力してください。"
#       end
#     end

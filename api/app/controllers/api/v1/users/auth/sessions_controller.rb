class Api::V1::Users::Auth::SessionsController < DeviseTokenAuth::SessionsController
  ...
  def render_create_success 
    render './api/v1/users/auth/success', locals: { notice: I18n.t('devise.sessions.signed_in') }
  end
  ...
  def render_destroy_success
    render './api/v1/users/auth/success', locals: { notice: I18n.t('devise.sessions.signed_out') }
  end
end

  ...
  def create
    ...
    if article
      ActiveRecord::Base.transaction do
        ...
        render './api/v1/article_favorites/success', locals: { notice: I18n.t('notice.article_favorite.create') }
      end
    else
  ...
  def destroy
    ...
    if article
      ActiveRecord::Base.transaction do
        ...
        render './api/v1/article_favorites/success', locals: { notice: I18n.t('notice.article_favorite.destroy') }
      end
    else
